...
<section class="container mb-5 d-flex align-items-center justify-content-center" style="margin-top:150px;margin-bottom:350px;">
     <form style="border-radius:10px;" action="{{ route('createowl') }}" class="form-groups bg-warning p-5 border-1" method="post"  style="margin-left:100px;" enctype="multipart/form-data">
      @csrf
        ...
        <button type="submit" class="btn btn-primary w-50 mt-3">Add Owl</button>
    </form>
  </section>
